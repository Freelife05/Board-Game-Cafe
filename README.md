...
| База данни | SQLite + Entity Framework Core 9 |
...
| Condition | string (max 20) | Состояние на играта |
...
| PUT | /api/reservations/{id} | Auth | Редактиране |
